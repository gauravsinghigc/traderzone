  <footer class="footer ">
                  ...
                  <div class="row gy-5 gx-4">
                      <div class="col-md-6">
                          <div class="footer__about">
                              <a href="index.php" class="footer__about-logo"><img style="width:100px !important;" src="<?php echo WEBSITE_INFO['LOGOS']['SQAURE']; ?>"
                                      alt="Logo"></a>
                                      ...
                                      <div class="footer__app-inner">
                                          <div class="footer__app-thumb">
                                              <a href="https://www.apple.com/app-store/" target="_blank" class="stretched-link">
                                                  <img src="<?php echo STORAGE_URL; ?>/images/footer/apple.png" alt="apple-icon">
                                              </a>
                                          </div>
                                      ...
                                      <div class="footer__app-inner">
                                          <div class="footer__app-thumb">
                                              <a href="https://play.google.com/store" target="_blank" class="stretched-link">
                                                  <img src="<?php echo STORAGE_URL; ?>/images/footer/play.png" alt="playstore-icon">
                                              </a>
                                          </div>
                                          <div class="footer__app-content">
                                              <span>GET IT ON</span>
              ...
              <div class="footer__bottom">
                  <div class="footer__end">
                      <div class="footer__end-copyright">
                          <p class=" mb-0">© 2024 All Rights Reserved By <a href="<?PHP echo DOMAIN; ?>"
                                  target="_blank"><?PHP echo WEBSITE_INFO['PRIMARY_INFO']['WEBSITE_NAME']; ?></a> </p>
                      </div>
                      <div>
                          <ul class="social">
      ...
      <div class="footer__shape">
          <span class="footer__shape-item footer__shape-item--1"><img src="<?php echo STORAGE_URL; ?>/images/footer/1.png"
                  alt="shape icon"></span>
  ...
  <!-- <div class="lightdark-switch">
      <span class="switch-btn">
          <img src="<?php echo STORAGE_URL; ?>/images/icon/moon.svg" alt="light-dark-switchbtn" class="swtich-icon">
      </span>
  </div> -->